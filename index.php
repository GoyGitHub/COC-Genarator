...
$schoolOptions = uniqueOptions(array_merge($defaultSchools, $dbSchools, [old('school')]));
$departmentOptions = uniqueOptions(array_merge($defaultDepartments, $dbDepartments, [old('department')]));
